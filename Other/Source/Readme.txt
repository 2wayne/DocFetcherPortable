...
user in an INI file next to DocFetcherPortable.exe called DocFetcherPortable.ini.
...
copy AppNamePortable.ini from this directory to DocFetcherPortable.ini next to
DocFetcherPortable.exe. The options in the INI file are as follows:
